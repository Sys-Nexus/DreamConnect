...
class LatentDiffusion(DDPM):
    ...
    def get_learned_conditioning(self, c, is_return_pool=False):
        ...
        # import pdb; pdb.set_trace();
        if isinstance(c, list): return c[1]
        else: return c
    ...
    def get_input(self, batch, k, return_first_stage_outputs=False, force_c_encode=False,
        ...
        null_prompt = self.get_learned_conditioning([""], is_return_pool=True)[1].unsqueeze(1).repeat(x.size(0),1,1)
        ...
        if force_c_encode is True:
            ...
            cond["c_crossattn"] = [torch.where(prompt_mask, null_prompt, self.get_learned_conditioning(xc["c_crossattn"], is_return_pool=True)[1].detach().unsqueeze(1))]
