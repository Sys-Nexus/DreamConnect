...
class ControlLDM(LatentDiffusion):
    ...
    def log_images(self, batch, epoch_n, iter_n, batch_idx, model_wrap, model_wrap_cfg,
        ...
        if True:
            ...
            z_pred_lowlevel = torch.randn_like(z_gt) * sigmas[0]
            z_pred_lowlevel = K.sampling.sample_euler_ancestral(model_wrap_cfg, z_pred_lowlevel, sigmas, extra_args=extra_args)
            ...
            x_lowlevel = F.interpolate(x_lowlevel, (256, 256))
