...
class TimestepEmbedSequential(nn.Sequential, TimestepBlock):
    ...
    def forward(self, x, emb, context=None, out_layers_injected=None, self_attn_k_injected=None, self_attn_v_injected=None, context_mask=None):
        for layer in self:
            if isinstance(layer, ResBlock):
                ...
                x = layer(x, context, self_attn_k_injected=self_attn_k_injected, self_attn_v_injected=self_attn_v_injected, context_mask=context_mask)
            else:
...
class ResBlock(TimestepBlock):
    ...
    def forward(self, x, emb, out_layers_injected=None):
        ...
        """
        if out_layers_injected is None:
