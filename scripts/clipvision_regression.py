...
def main():
    ...
    train_clip = np.load('nsd_data_dir/extracted_features/subj{:02d}/nsd_clipvision_train.npy'.format(sub))
    test_clip = np.load('nsd_data_dir/extracted_features/subj{:02d}/nsd_clipvision_test.npy'.format(sub))
    ...
    with open('nsd_data_dir/regression_weights/subj{:02d}/clipvision_regression_weights.pkl'.format(sub),"wb") as f:
